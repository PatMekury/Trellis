...
def main():
    ...
    static = df.groupby(["lganame","wardname"]).agg(
    ...
    print(static.head(15)[["rank","lganame","wardname","score","pop_under5","no2_umol_m2_mean","flare_total_bcm_13yr","fac_phc","phc_per_1k_u5"]].to_string(index=False))

    print("\nBottom 5 (least priority):")
    print(static.tail(5)[["rank","lganame","wardname","score","pop_under5","no2_umol_m2_mean","fac_phc"]].to_string(index=False))
