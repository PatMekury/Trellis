...
ALLOCATION = [
    ...
    # PHC nodes (10)
    ("Warri South",      "Ekurede",     "PHC",       "Rank 1 overall; 12k under-5; second-highest NO2; 11 PHCs to host the node"),
    ...
    ("Warri South-West", "Ugborodo",    "PHC",       "Flare-belt centre; Escravos terminal vicinity; underserved PHCs"),
    ...
    ("Warri South",      "Igbudu",      "school",    "Largest under-5 pop; 14 PHCs to anchor a multi-stakeholder partnership"),
    ("Warri South-West", "Okerenkoko",  "school",    "Flare-belt school; high flare exposure with limited PHCs"),
    ("Warri South-West", "Ajudaibo",    "school",    "Coastal mangrove sentinel; low pop but in the flare-corridor"),
    ("Bomadi",           "Akugbene 1",  "school",    "Bomadi equity ward; 0 PHCs; school is the only health-adjacent observation point"),
    ("Bomadi",           "Esanma",      "school",    "Riverine Bomadi school; pairs with Kpakiama PHC catchment"),
    ("Patani",           "Patani 2",    "school",    "Zero facilities, zero PHCs; school is the only candidate node site in this ward"),
    ...
    ("Burutu",           "Bolou-Ndoro", "school",    "Inland Burutu coverage; complements Ogulagha and Kiagbodo PHC nodes"),

    # Community nodes (5)
    ("Warri South",      "Avenue",      "community", "Mid-density urban Warri; complements Ekurede/Ubeji refinery cluster"),
    ...
    ("Patani",           "Buluangiama", "community", "Patani LGA broad-coverage community node; one of the higher-NO2 Patani wards (29 umol/m^2 in April)"),
...
def main():
    ...
    df = df.merge(
        scores[["lganame","wardname","score","rank","pop_under5","no2_umol_m2_mean","fac_phc","flare_total_bcm_13yr"]],
        on=["lganame","wardname"], how="left",
    )
    df = df[["node_id","channel","lganame","wardname","rank","score",
             "pop_under5","no2_umol_m2_mean","fac_phc","flare_total_bcm_13yr","rationale"]]
    ...
    for ch in ("PHC","school","community"):
        ...
        print(df[df.channel==ch][["node_id","lganame","wardname","rank","pop_under5","no2_umol_m2_mean","fac_phc"]].to_string(index=False))
